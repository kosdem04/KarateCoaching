...
class EventRequest:
    ...
    @classmethod
    async def get_event_students(cls, session: AsyncSession, event_id: int):
        query = (
            select(EventORM)
            .options(
    ...
    @classmethod
    async def add_event(cls, session, name: str, type_id: int,
                        date_start: datetime.date, date_end: datetime.date, coach_id: int):
        query = (
            select(EventORM)
    ...
    @classmethod
    async def add_event_student(cls, session, event_id: int, student_id: int):
        query = (
    ...
    @classmethod
    async def update_event(cls, session, name: str, type_id: int,
                        date_start: datetime.date, date_end: datetime.date, event_id: int):
        query = (
            update(EventORM)
            .where(EventORM.id == event_id)
            .values(
    ...
    @classmethod
    async def delete_student_from_event(cls, session, event_id: int, student_id: int):
        query = (
